...
# Introduction
The increasing availability of compilations and databases of deep-time climate data now offers the opportunity for empirical palaeoclimate reconstructions of unprecedented scope [e.g. @Veizer2015; @Hollis2019; @Grossman2022; @Judd2022]. In order for these reconstructions to be effective, two fundamental challenges need to be overcome: 1) disparate types of proxy data need to be integrated to inform a single climate reconstruction, and 2) large-scale scale climate patterns need to be inferred from localised, often sparse observations. 

For the marine realm, most palaeoclimate reconstructions use geochemical proxy data
