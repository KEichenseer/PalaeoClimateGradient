...
The early Eocene GMsST is estimated at `r eotemp_global$"50%"` (`r eotemp_global$"2.5%"` - `r eotemp_global$"97.5%"`) degC,  `r  round(as.numeric(eotemp_global$"50%") - as.numeric(motemp_global$"50%"),1)` degC  higher than the modern.

A model run excluding the ecological proxies results in a similar median latitudinal gradient, `r eocene_proxy_gradient$"50%"` degC, but with a `r proxy_uncertain_diff_percent`% wider 95% CI (Supplementary materials). This indicates that the ecological proxy data are broadly in agreement with the geochemical proxies, while providing additional constraints on the shape of the early Eocene temperature gradient. 
