...
Geochemical climate proxy data were extracted from a latest Paleocene and early Eocene compilation [@hollis2019]. This compilation provides four different geochemical proxies for reconstructing seawater temperature: d180, d47, Mg/Ca and TEX86. For our analyses, this dataset was restricted to the EECO and contains four commonly used geochemical climate proxies: d180, d47, Mg/Ca and TEX_86_ (REFS). For a detailed description of each proxy see [@hollis2019].
