...
The global early Eocene mean sea surface temperature is estimated at `r eotemp_global$"50%"` (`r eotemp_global$"2.5%"` - `r eotemp_global$"97.5%"`) degC, significantly higher than the modern (`r motemp_global$"50%"` degC).
...
Modelling the latitudinal temperature gradient from the equator to the poles facilitates reconstruction of the global mean temperature.
