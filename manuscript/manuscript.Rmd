...
We apply this approach to the record of the early Eocene climatic optimum (EECO), the interval with the warmest sustained temperatures of the Cenozoic [@Pross2012]. The early Eocene is the focus of a substantial body of palaeoclimate literature [@Berggren1998; @Thomas2000; @Hyland2017; @Lunt2021], as it potentially represents an analogue for extreme climate warming scenarios [@Burke2018]. For palaeoclimate modelers, the early Eocene presents a challenge: Geochemical proxy data [@Hollis2019] and ecological data [@Marwick1994; @Greenwood1995] indicate tropical to subtropical conditions up to high latitudes, but early climate models have not been able to model warm polar temperatures and a shallow latitudinal temperature gradient under realistic conditions [@Sloan1990; ...]. Although some more recent climate models have been able to align their simulations with the proxy record [@Huber2013;...], the nature of the early Eocene temperature gradient remains a matter of debate. A relatively recent, proxy-based studies inferred a SST gradient that was shallower than the modern by 32+-10 % [@Evans2018], which would correspond to a gradient of ~20+-3 degC. Later studies based on new proxy compilations only estimate temperature gradients up to mid-latitudes [@Hollis2019], or combine SST proxies with other data [@Inglis2020], making it difficult to infer a meaningful estimate of the SST gradient. 
