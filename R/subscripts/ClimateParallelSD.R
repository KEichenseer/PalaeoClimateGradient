...
climate_parallel_sd <- function(nChains = 3, nIter = 1000, obsmat = NULL, distrmat = NULL, coeff_inits = NULL, sdy_init = NULL, 
                             yest_inits = NULL, sdyest_inits = NULL, logprior = logprior,
