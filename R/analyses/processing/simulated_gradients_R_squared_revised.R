...
four_gradients_model <- readRDS("D://OneDrive - Durham University/projects/four_gradients_revised_model_proc.rds")
...
plot(lats,gradient_formulas_static[[1]](lats), type = "l")
...
saveRDS(r2_long,"./results/simulation/simulated_gradients_r_squared_gelman_unweighted_revised.rds")
